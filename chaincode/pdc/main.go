...
// fabkit chaincode instantiate pdc 1.0 mychannel 1 0 --collections-config ./chaincode/pdc/collections_config.json -P "OR('Org1MSP.member','Org2MSP.member','Org3MSP.member')"
